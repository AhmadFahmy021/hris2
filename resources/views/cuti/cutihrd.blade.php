            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                        ...
                        {{-- <a class="dropdown-item" href="/cuti"><i class="fas fa-calendar-plus"></i> Pengajuan Cuti</a> --}}
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered" id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/cuti/{{Crypt::encrypt($dt->id)}}/edit" class="btn btn-primary"><i class="fas fa-pen"></i> Edit</a>
                                    <a href="/cuti/{{Crypt::encrypt($dt->id)}}/delete" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
