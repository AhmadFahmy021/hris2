...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Gaji Karyawan</h1>
    <a href="/kelola/gaji/create" class="d-inline d-sm-inline-block btn btn-sm btn-primary shadow-sm">
        <i class="fas fa-plus fa-sm text-white-50"></i> 
        Tambah Gaji Karyawan
    </a>
</div>
                        ...
                        <tbody>
                            @foreach ($data as $dt)
                                <tr>
                                    ...
                                    <td>{{$dt->lembur}}</td>
                                    <td>
                                        <a href="/kelola/gaji/{{Crypt::encrypt($dt->id)}}/edit" class="btn btn-primary"><i class="fas fa-edit text-white-50"></i> Edit</a>
                                        <a href="/kelola/gaji/{{Crypt::encrypt($dt->id)}}" class="btn btn-danger" data-confirm-delete="true"><i class="fas fa-trash text-white-50"></i> Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
