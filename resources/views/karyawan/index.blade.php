                        ...
                        <table class="table table-bordered" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endphp
                                    <td>
                                        <a href="/kelola/karyawan/{{$id}}/detail" class="btn btn-success"><i class="fas fa-eye"></i> Detail</a>
                                        <a href="/kelola/karyawan/{{$id}}/edit" class="btn btn-primary"><i class="fas fa-pen"></i> Edit</a>
                                        <a href="/kelola/karyawan/{{$id}}/delete" id="delete" class="btn btn-danger"><i class="fas fa-trash text-white-50"></i> Delete</a>
                                        {{-- <form action="/karyawan/{{$id}}/delete" method="post" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</button>
                                        </form> --}}
