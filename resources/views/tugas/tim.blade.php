...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="/kelola/tugas/divisi/create" class="btn btn-primary btn-sm"><i class="fas fa-plus text-white-50"></i>
        Tambah Tugas
    </a>
</div>
                        ...
                        <tbody>
                            @foreach ($data as $d)                                
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="/kelola/tugas/divisi/{{Crypt::encrypt($d->id)}}/edit" class="btn btn-primary"><i class="fas fa-pen text-white-50"></i></a>
                                        <a href="/kelola/tugas/divisi/{{Crypt::encrypt($d->id)}}/delete" class="btn btn-danger"><i class="fas fa-trash text-white-50"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        ...
                        <tbody>
                            @foreach ($data as $d)                                
                                <tr>
                                    ...
                                    <td>
                                        <a href="/divition/tugas/{{Crypt::encrypt($d->id)}}/selesai" class="btn btn-primary"><i class="fas fa-check text-white-50"></i> Selesai</a>
                                        <a href="/divition/tugas/{{Crypt::encrypt($d->id)}}/tunda" class="btn btn-danger"><i class="fas fa-times text-white-50"></i> Tunda</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
